  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span> Career-G</span></a>
      </div>
...
<!--    end of signup form-->
    ...
    <div class="content">
    Welcome to Career-G, where we're passionate about providing quality education to learners of all backgrounds. 
    Our platform offers a wide range of expertly crafted courses in various subjects, designed for flexible, self-paced learning. Our team of educators, content creators, and tech enthusiasts is dedicated to making education accessible and affordable. Join us on this exciting learning journey, and let's grow and succeed together.
    Thank you for choosing Career-G as your partner in education.
    </div>
   <hr>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
  ...
  <footer id="footer" class="footer">
    <div class="container text-center">
      ...
      ©2016 Career-G  All rights reserved
      <div class="credits">
        <!--
